...
class Game {
	...
	static void fullTournament() throws Exception {
		...
		al.add(new CoryMcDonaldTurnt());
		al.add(new ChandramohanSol());
		al.add(new CharlesBurks());
	...
	public static void main(String[] args) throws Exception {
		...
		// Controller.doBattle(new CoryMcDonald(), new ChandramohanSol());
		// Controller.doBattle(new ChandramohanSol(), new Better());
		fullTournament();
	}
}
